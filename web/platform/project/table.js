...
var table = {
    ...
    methods: {
        updateClick(obj) {
            this.$parent.updateProject(obj);
        },
        destroyClick(obj) {
            this.$parent.destroyProject(obj);
        }
    }
};
